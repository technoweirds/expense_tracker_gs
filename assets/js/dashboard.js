(function ($) {
  ...
  if ($("#traffic-chart").length) {
    ...
    var graphGradient6 = document.getElementById("traffic-chart").getContext('2d');
    ...
    // Three more gradients that suit the existing color palette

    // Gradient 4: Yellow/Orange
    var gradientStrokeYellowOrange = graphGradient4.createLinearGradient(0, 0, 0, 200);
    gradientStrokeYellowOrange.addColorStop(0, 'rgba(255, 234, 167, 1)');
    gradientStrokeYellowOrange.addColorStop(1, 'rgba(255, 167, 84, 1)');
    var gradientLegendYellowOrange = 'rgba(255, 234, 167, 1)';

    // Gradient 5: Purple/Pink
    var gradientStrokePurplePink = graphGradient5.createLinearGradient(0, 0, 0, 250);
    gradientStrokePurplePink.addColorStop(0, 'rgba(179, 136, 255, 1)');
    gradientStrokePurplePink.addColorStop(1, 'rgba(248, 187, 208, 1)');
    var gradientLegendPurplePink = 'rgba(179, 136, 255, 1)';

    // Gradient 6: Teal/Cyan
    var gradientStrokeTealCyan = graphGradient6.createLinearGradient(0, 0, 0, 150);
    gradientStrokeTealCyan.addColorStop(0, 'rgba(0, 172, 193, 1)');
    gradientStrokeTealCyan.addColorStop(1, 'rgba(128, 222, 234, 1)');
    var gradientLegendTealCyan = 'rgba(0, 172, 193, 1)';
